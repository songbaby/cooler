...
<html>
    <head>
        ...
        <meta http-equiv="content-type" content="text/html;charset=utf-8">
            <link href="<?php echo ($smarty["const"]["ADMIN_CSS_URL"]); ?>mine.css" type="text/css" rel="stylesheet" />
    </head>
    ...
    <body>
        ...
        <div class="div_head">
            <span>
                ...
                <span style="float:right;margin-right: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="<?php echo ($smarty["const"]["/cooler/index.php/Admin"]); ?>/Goods/showlist">【返回】</a>
                </span>
            </span>
        </div>
        <div></div>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="<?php echo ($smarty["const"]["/cooler/index.php/Admin/Goods/upd/goods_id/mine.css"]); ?>" method="post" enctype="multipart/form-data">
                {*隐藏域传递被修改的商品id信息*}
