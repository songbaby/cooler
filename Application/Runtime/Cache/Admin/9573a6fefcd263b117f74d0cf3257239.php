        ...
        <div id="user_login">
            <dl>
                <dd id="user_top">
                    ...
                    <form action="/cooler/index.php/Admin/Manager/login" method="post">
                        <ul>
                            <li class="user_main_l"></li>
                            <li class="user_main_c">
                                <div class="user_main_box">
                                    <ul>
                                        <li class="user_main_text"><?php echo ($lang["USERNAME"]); ?></li>
                                        <li class="user_main_input">
                                            <input class="TxtUserNameCssClass" id="admin_user" maxlength="20" name="mg_username"> </li></ul>
                                    <ul>
                                        <li class="user_main_text"><?php echo ($lang["PASSWORD"]); ?> </li>
                                        <li class="user_main_input">
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            ...
                                            <img src="/cooler/index.php/Admin/Manager/verifyImg"  alt="" />
                                        </li>
                                    </ul>
                                </div>
                            </li>
