        ...
        <div class="div_head">
            <span>
                ...
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="/cooler/index.php/Home/Goods/add">【添加商品】</a>
                </span>
            </span>
        </div>
        <div></div>
            ...
            <table class="table_a" border="1" width="100%">
                <tbody><tr style="font-weight: bold;">
                    ...
                    <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr id="product1">
                        ...
                        <td><a href="/cooler/index.php/Home/Goods/upd/goods_id/<?php echo ($v["goods_id"]); ?>">修改</a></td>
                        <td><a href="/cooler/index.php/Home/Goods/del/goods_id/<?php echo ($v["goods_id"]); ?>">删除</a></td>
