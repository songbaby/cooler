...
<body>
    ...
    <div class="content-top">
        ...
        <div class="right-con">
            ...
            <div class="show-box">
                ...
                <div class="content">
                    <ul class="imgBox">
                        <li><a href="#"><img src="/cooler/Public/Home/img/1.jpg"></a></li>
                        <li><a href="#"><img src="/cooler/Public/Home/img/2.jpg"></a></li>
                        <li><a href="#"><img src="/cooler/Public/Home/img/3.jpg"></a></li>
                        <li><a href="#"><img src="/cooler/Public/Home/img/4.jpg"></a></li>
                        <li><a href="#"><img src="/cooler/Public/Home/img/5.jpg"></a></li>
                    </ul>
               ...
               <a style="float: left" href="#"><img src="/cooler/Public/Home/img/6.6.jpg" /></a>
                <!--content-down-->
                <div class="content-down">
                    <ul class="imgBox1">
                        <li>
                            <a href="#"><img src="/cooler/Public/Home/img/01.png" /></a>
                            <a href="#"><img src="/cooler/Public/Home/img/02.jpg" /></a>
                            <a href="#"><img src="/cooler/Public/Home/img/03.png" /></a>
                            <a href="#"><img src="/cooler/Public/Home/img/04.png" /></a>
                        </li>
                        <li>
                            <a href="#"><img src="/cooler/Public/Home/img/01.png" /></a>
                            <a href="#"><img src="/cooler/Public/Home/img/02.jpg" /></a>
                ...
                <a style="float: left" href="#"><img src="/cooler/Public/Home/img/15.jpg" /></a>
            </div>
            <!--right-sidbar-->
            <div class="right-sidebar">
                ...
                <div class="user-info">
                    <div class="gold-top">
                        <img width="62px" height="62px" src="/cooler/Public/Home/img/user-head.jpg" />
                ...
                <div class="service">
                    ...
                    <div id="service-1" class="service-cell service-z">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/phone.png" /></h5>
                        <h6>话费</h6>
                        <i class="fa fa-angle-down"></i>
                    </div>
                    <div id="service-2" class="service-cell service-z">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/game.png" /></h5>
                        <h6>游戏</h6>
                        <i class="fa fa-angle-down"></i>
                    </div>
                    <div id="service-3" class="service-cell service-z">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/plane.png" /></h5>
                        <h6>旅行</h6>
                        <i class="fa fa-angle-down"></i>
                    </div>
                    <div id="service-4" class="service-cell service-z">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/save.png" /></h5>
                        <h6>保险</h6>
                        <i class="fa fa-angle-down"></i>
                    </div>
                    <div class="service-cell">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/18.png" /></h5>
                        <h6>彩票</h6>
                    </div>
                    <div class="service-cell">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/move.png" /></h5>
                        <h6>电影</h6>
                    </div>
                    <div class="service-cell">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/eat.png" /></h5>
                        <h6>点外卖</h6>
                    </div>
                    <div class="service-cell">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/money.png" /></h5>
                        <h6>理财</h6>
                    </div>
                    <div class="service-cell">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/book.png" /></h5>
                        <h6>电子书</h6>
                    </div>
                    <div class="service-cell">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/miusc.png" /></h5>
                        <h6>音乐</h6>
                    </div>
                    <div class="service-cell">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/bag.png" /></h5>
                        <h6>水电煤</h6>
                    </div>
                    <div class="service-cell">
                        <h5 class="service-i"><img src="/cooler/Public/Home/img/....png" /></h5>
                        <h6>请期待</h6>
                    </div>
                </div>
                <!--service-box-->
    ...
    <div class="main">
            ...
            <div class="product-box">
                <div class="inner-info">
                    ...
                    <div class="inner-left">
                        <img src="/cooler/Public/Home/img/show1.png" />
                    ...
                    <div class="inner-right">
                        <div>
                            <a href="#">
                                <img src="/cooler/Public/Home/img/shooes.jpg" />
                                <p>春夏美鞋</p>
                            </a>
                            <a href="#">
                                <img src="/cooler/Public/Home/img/c.gif" />
                                <p>春季亮色搭</p>
                            </a>
                        </div>
        ...
        <div class="main-right">
            <div class="time-go">
                <div class="time-cell">
                    ...
                    <div class="inner-show">
                        <a href="#">
                            <img src="/cooler/Public/Home/img/inner1.png">
                            <p class="price-info">￥118.00</p>
                        </a>
                        <a href="#">
                            <img src="/cooler/Public/Home/img/inner2.png">
                            <p>￥118.00</p>
                        </a>
                        <a href="#">
                            <img src="/cooler/Public/Home/img/inner3.png">
                            <p>￥118.00</p>
                        </a>
                ...
                <div class="dynamic">
                    ...
                    <a href="#"><img width="80px" height="80px" src="/cooler/Public/Home/img/dynamic1.jpg"></a>
                    <a href="#"><img width="80px" height="80px" src="/cooler/Public/Home/img/dynamic2.jpg"></a>
                    <a href="#"><img width="80px" height="80px" src="/cooler/Public/Home/img/dynamic3.jpg"></a>
            ...
            <div class="fix-right-sub">
                ...
                <div class="gogo-choose">
                    ...
                    <div class="sub-show">
                        <div class="content-sub">
                            <ul class="imgBox2">
                                <li><a href="#"><img src="/cooler/Public/Home/img/sub1.jpg"></a></li>
                                <li><a href="#"><img src="/cooler/Public/Home/img/sub2.jpg"></a></li>
                                <li><a href="#"><img src="/cooler/Public/Home/img/sub3.jpg"></a></li>
                            </ul>
                        ...
                        <div class="sub-right">
                            <img src="/cooler/Public/Home/img/hand.jpg" />
                            <img src="/cooler/Public/Home/img/aaaaa.jpg" />
                        </div>
                    ...
                    <!--just-look-->
                    <div class="just-look">
                        <a href="#"><img src="/cooler/Public/Home/img/female.png"><h6>超美公主装搭配</h6></a>
                        <a href="#"><img src="/cooler/Public/Home/img/home.jpg"><h6>小户型这样装</h6></a>
                        <a href="#"><img src="/cooler/Public/Home/img/shoes.jpg"><h6>闪耀水钻凉鞋</h6></a>
                    </div>
                    <p class="text-show">
                ...
                <!--last-->
                <div class="last-box">
                    <img src="/cooler/Public/Home/img/last1.png" />
                    <img src="/cooler/Public/Home/img/last2.jpg" />
                </div>
            </div>
    ...
    <div class="main-bottom">
        ...
        <div class="single-sale">
            <a href="#">
                <img src="/cooler/Public/Home/img/sing1.jpg" />
                <h3>褶皱立领雪纺衫</h3>
            </a>
    ...
    <!--ad-->
    <div class="ad">
        <img src="/cooler/Public/Home/img/ad.jpg" />
        <img src="/cooler/Public/Home/img/ad1.jpg" />
    </div>
    <!--help-->
    <div class="help">
        <div class="help-info">
            <h1><img src="/cooler/Public/Home/img/help4.png"><span class="help-text">消费者保障</span></h1>
        ...
        <div class="help-info">
            <h1><img src="/cooler/Public/Home/img/help1.png"><span class="help-text">新手上路</span></h1>
        ...
        <div class="help-info">
            <h1><img src="/cooler/Public/Home/img/help2.png"><span class="help-text">付款方式</span></h1>
        ...
        <div class="help-info">
            <h1><img src="/cooler/Public/Home/img/help3.png"><span class="help-text">淘宝特色</span></h1>
